...
<form action="index.php?ctrl=security&action=updatePasswordForm" method="post">
    ...
    <div>
        ...
        <input type="email" name="userEmail" id="email" required=true>
    ...
    <div>
        ...
        <input type="password" name="newPassword" id="password" required=true>
